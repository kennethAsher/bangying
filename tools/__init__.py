...
@author: kennethAsher
@fole  : __init__.py.py
@ctime : 2019/12/25 10:36
@Email : 1131771202@qq.com
"""

import re

provincePat = re.compile(r'(.*(|河北|山西|辽宁|吉林|黑龙江|江苏|浙江|安徽|福建|江西|山东|河南'
...
str = '民事案件|2009-09-30|达尔罕茂明安联合旗人民法院|一审|劳动合同纠纷|马万青|内蒙古天骄律师事务所省'
matcher = cityPat.match(str)
print(matcher.group(0)+'市')